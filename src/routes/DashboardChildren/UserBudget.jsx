...
export default function UserBudget({ user, resetUsers }) {
  ...
  return (
    <>
      <Button onClick={onClickModal}>Transactions</Button>
        ...
        <ModalContent>
          ...
          <ModalBody>
            <div className="balance-container">
              ...
              ></input>
              <button onClick={deposit} className="transaction-button">
                Deposit
              </button>
              <button onClick={withdraw} className="transaction-button">
                Withdraw
              </button>
            </div>
            <TableContainer>
